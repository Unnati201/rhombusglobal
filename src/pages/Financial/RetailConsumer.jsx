...
import Healthcare from '../Healthcare&lifeScience/Healthcare&science';
import Retailsimage  from "../../asserts/consumergoods.jpg";
import "./Retailconsumer.css";
import retailsimg  from "../../asserts/ourfocus.jpg";
...
const RetailConsumer = () => {
  ...
  <img className="healthcare_data" src={Retailsimage} alt="" />
  </div>
<div className="healthcare-overlay"></div>

<div className="healthcare-content">
<h1 className="healthcare-title">Retail, Consumers and Goods</h1>
...
<div className="aboutUs_story-banner_ourapproach">
  <img className='image_aboutus_ourapproach'  src={retailsimg} alt="" />
