...
import industimg  from "../../asserts/telecom.jpg";
import industimg1  from "../../asserts/telecom.jpg";
 import "./Industrial.css";


import Healthcare from './Healthcare&science';

const InduatrialGoods = () => {
  return (
    <div className="healthcare-banner">
    <div className="healthcare_img_first">
  <img className="healthcare_data" src={industimg} alt="" />
  </div>
<div className="healthcare-overlay"></div>

<div className="healthcare-content">
<h1 className="healthcare-title">Industrial Goods & Manufacturing</h1>
...
<div className="aboutUs_story-banner_ourapproach">
  <img className='image_aboutus_ourapproach'  src={industimg1} alt="" />
...
export default InduatrialGoods
