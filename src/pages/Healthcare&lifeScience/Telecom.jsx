...
import telecomimage  from "../../asserts/telecom.jpg";
import "./Telecom.css";
...
const Telecom = () => {
  ...
  <img className="healthcare_data" src={telecomimage} alt="" />
  </div>
<div className="healthcare-overlay"></div>

<div className="healthcare-content">
<h1 className="healthcare-title">Telecom & Media</h1>
...
<div className="aboutUs_story-banner_ourapproach">
  <img className='image_aboutus_ourapproach'  src={telecomimage} alt="" />
