...
import "./Traveltransp.css";
import travelimg  from "../../asserts/travel.jpg";
...
const TravelTransportation = () => {
  ...
  <img className="healthcare_data" src={travelimg} alt="" />
  </div>
<div className="healthcare-overlay"></div>

<div className="healthcare-content">
<h1 className="healthcare-title">Travel ,Transportation and Hospitality</h1>
...
<div className="aboutUs_story-banner_ourapproach">
  <img className='image_aboutus_ourapproach'  src={travelimg} alt="" />
